...
namespace BHZ.Migrations
{
    ...
    [Migration("20231024081240_AnimalsVisitTable")]
    partial class AnimalsVisitTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimalVisit", b =>
                {
                    ...
                    b.HasKey("AnimalsID", "visitsId");

                    b.HasIndex("visitsId");

                    b.ToTable("AnimalVisit", (string)null);
                });
            ...
            modelBuilder.Entity("AnimalVisit", b =>
                {
                    b.HasOne("BHZ.Models.Animal", null)
                        .WithMany()
